...
40. [Bloco PL/SQL X Comandos DCL](#bloco-plsql-x-comandos-dcl)
...
99. [Componentes (construções) Públicos de uma Package](#componentes-construções-públicos-de-uma-package)
